...
different things in this workspace. None of the seven installed so far declare content, so the
folder does not exist yet; the first library that needs it creates it.
