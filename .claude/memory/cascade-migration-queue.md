...
metadata: 
  ...
  modified: 2026-09-11T15:01:30.933Z
---
...
Known linter gap from that migration: `constant_outside_config` flags `SPEC` in `db_spec.py`, but
the cascade contract requires it there; the check needs a db_spec exemption — awaiting Tim's call.
