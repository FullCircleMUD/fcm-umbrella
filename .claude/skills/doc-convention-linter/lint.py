#!/usr/bin/env python3
"""doc-convention-linter — deterministic checks on the FCM documentation corpus.
...
Run from the umbrella root:  python .claude/skills/doc-convention-linter/lint.py
"""
...
def discover(root: Path):
    """Return (doc_roots, loose_files) for the whole FCM doc corpus.
...
def main(argv=None):
    ap = argparse.ArgumentParser(description="Deterministic FCM doc-convention linter.")
