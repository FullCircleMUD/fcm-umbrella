...
Original to FCM (not vendored). Pure Python standard library (`tomllib` for pyproject parsing, present in
Python 3.11+) — no third-party dependencies, so it runs anywhere Python 3.11+ does and ships complete
with its own tests.
